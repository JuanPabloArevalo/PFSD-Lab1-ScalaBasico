...
class TransactionsOperationsTest extends FunSuite {
  ...
  val t3 = new Transaction(5.0, "EUR", "Expense")
  val t4 = new Transaction(200000.0, "COP", "Expense")
  val t5 = new Transaction(200000.0, "COP", "Expense")
  ...
  test("Test Distinct") {
    val distincts = TransactionsOperations.distinct(transactions3.asJava).asScala
    assert(distincts.length === 4)
  }
